...
class FaceDetector():
    def __init__(self, minDetecionCon=0.5):
        self.minDetectionCon = minDetecionCon
        self.mpFaceDetection = mp.solutions.face_detection
        self.mpDraw = mp.solutions.drawing_utils
        self.faceDetection = self.mpFaceDetection.FaceDetection(minDetecionCon)
    ...
    def fancyDraw(self, img, bbox, l=25, t=7, rt=1):
        x, y, w, h = bbox
        x1, y1 = x + w, y + h
...
def main():
    ...
    while True:
        ...
        cv2.putText(img, "FPS: " + str(int(fps)), (25, 50), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
